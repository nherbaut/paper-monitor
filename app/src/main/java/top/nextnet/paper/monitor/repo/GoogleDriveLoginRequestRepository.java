...
@ApplicationScoped
public class GoogleDriveLoginRequestRepository implements PanacheRepository<GoogleDriveLoginRequest> {

    public Optional<GoogleDriveLoginRequest> findByState(String state) {
